...
- Aviation section: when storms within ~30 mi are APPROACHING DIRECTLY or NEAR MISS, lead with convective hazards (turbulence, lightning, IFR in TSRA, possible convective downdrafts, icing if cold) rather than the VFR/MVFR ceiling-visibility category. It is misleading to call conditions VFR while thunderstorms are expected — if you mention the flight category, immediately qualify it with the convective threat.
